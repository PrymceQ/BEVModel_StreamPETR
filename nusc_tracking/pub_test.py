...
def parse_args():
    ...
    parser.add_argument("--work_dir", help="the dir to save logs and tracking results", default='./tracking_out_results')
    parser.add_argument(
        "--checkpoint",
        default='/home/wangziqin/StreamPETR/val/work_dirs/stream_petr_vov_flash_800_bs2_seq_24e_20230726/Wed_Jul_26_10_38_31_2023/pts_bbox/results_nusc.json',
